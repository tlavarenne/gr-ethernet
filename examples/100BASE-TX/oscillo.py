...
class oscillo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "oscillo")
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(3)
        self.blocks_file_source_0_0_1 = blocks.file_source(gr.sizeof_float*1, 'Acquisitions100Mbps/RefCurve_2025-04-10_1_132807.Wfm.bin', True, 0, 0)
        ...
        self.connect((self.blocks_file_source_0_0_1, 0), (self.blocks_multiply_const_vxx_0_0, 0))
...
def main(top_block_cls=oscillo, options=None):
